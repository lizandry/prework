...
function exercise4(varA, varB) {
    ...
    if (varA == varB) {
        ...
        answer4 = (varA + " and " + varB + " are not equal");
    }
    // --------------------------------------------
    // And above here
    // --------------------------------------------
...
//sorry, we tried everything in here and couldn't come up with anything that didn't make sense.
//correction: quincey figured out that adding 16 zeros after a decimal point and then another character will create an error
//a volunteer also gave us this cool article with the data table: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Equality_comparisons_and_sameness
...
//
//a lot of the wording was unclear, but the volunteers and other apprentices helped a ton!
//mozilla's developer tools also rule!
